    ...
    <>
      ...
      <div className="intro">
        ...
        <p>
          ...
          couldn’t master everything in such a short time, so I decided to focus
          on web development while keeping game development as a future goal.
        </p>
        <p>
          As a web programmer, my journey has been nerve-cracking at times,
          exciting, and fun — especially working alongside great teammates. Now,
          I’m looking forward to learning more, growing my skills, and building
      ...
      <div className="work-style">
        ...
        <p>
          ...
          code clean, readable, and easy to maintain — while still leaving room
          for creativity in the design and functionality.
        </p>
      </div>
    </>
  );
